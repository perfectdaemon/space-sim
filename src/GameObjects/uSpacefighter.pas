...
uses
  ...
  GLFile3DS, VectorGeometry, VectorTypes, GLFilePNG,

  uGameObject, uLog, uEngine, uWeapon, uSimplePhysics, uDebugInfo, uBooster;
...
type
  ...
  public
    constructor CreateAsChild(aParent: TGLBaseSceneObject); reintroduce; virtual;
    ...
    {Ускоритель}
    property Booster: TdfBooster read FBooster write FBooster;
