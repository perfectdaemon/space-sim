...
uses
  ...
  GLScene, GLObjects, GLParticleFX, VectorGeometry, VectorTypes, GLTexture,
...
begin
  ...
  begin
    ...
    colorVec[0] := Ini.ReadFloat(C_GRAPHIC, 'ColorR', 1.0);
    colorVec[1] := Ini.ReadFloat(C_GRAPHIC, 'ColorG', 1.0);
    colorVec[2] := Ini.ReadFloat(C_GRAPHIC, 'ColorB', 1.0);
    colorVec[3] := Ini.ReadFloat(C_GRAPHIC, 'ColorA', 1.0);
