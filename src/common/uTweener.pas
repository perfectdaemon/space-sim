...
begin
  ...
  begin
    fValue^[0] := fEasingFunc(fStartValue[0], fFinishValue[0] - fStartValue[0], GetUnitValue);
    fValue^[1] := fEasingFunc(fStartValue[1], fFinishValue[1] - fStartValue[1], GetUnitValue);
    fValue^[2] := fEasingFunc(fStartValue[2], fFinishValue[2] - fStartValue[2], GetUnitValue);
  end;
end;
//------------------------------------------------------------------------------
