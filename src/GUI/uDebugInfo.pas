...
begin
  UpdateParam(aIndex,
    '['+FloatToStrF(aParam[0], ffGeneral, C_PRECISION, C_DIGITS) + '] [' +
        FloatToStrF(aParam[1], ffGeneral, C_PRECISION, C_DIGITS) + '] [' +
        FloatToStrF(aParam[2], ffGeneral, C_PRECISION, C_DIGITS) + ']');
end;
