...
uses
  ...
  GLFilePNG, GLFileDDS, VectorGeometry, VectorTypes, GLRenderContextInfo,
  GLKeyboard,
...
type
  ...
  private
    ...
    procedure OnRender(Sender: TObject; var rci: TRenderContextInfo);
...
procedure TdfInGameMenu.OnRender(Sender: TObject; var rci: TRenderContextInfo);
begin
